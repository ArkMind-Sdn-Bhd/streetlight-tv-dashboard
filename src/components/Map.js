...
export default function Maps({alertList, setAlertList}) {
	...
	return (
		<div className="map">
           ...
           */}
					{coordsList.map(({latitude, longitude, line1, line2, line3, pillar_id}, index) => (
						<Marker
							key={index}
							anchor="bottom"
							latitude={latitude}
